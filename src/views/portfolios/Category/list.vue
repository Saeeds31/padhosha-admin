                  ...
                  <td>
                    <div class="d-flex flex-wrap gap-1">
                      <router-link v-if="checkPermission(['portfoliocategory_update'])"
                        :to="`/portfolios/categories/${cat.id}/edit`" class="btn btn-sm btn-warning">
                        <i class="bi bi-pen"></i>
                        <span>ویرایش</span>
                      </router-link>
          ...
          <div class="d-md-none category-cards">
            ...
            >
              ...
              <div class="category-card-actions">
                <router-link v-if="checkPermission(['portfoliocategory_update'])"
                  :to="`/portfolios/categories/${cat.id}/edit`" class="btn btn-sm btn-warning flex-fill">
                  <i class="bi bi-pen"></i>
                  <span>ویرایش</span>
                </router-link>
                <button class="btn btn-sm btn-danger flex-fill" v-if="checkPermission(['portfoliocategory_delete'])"
                  @click="deleteCategory(cat.id)">
                  <i class="bi bi-trash3-fill"></i>
                  <span>حذف</span>
                </button>
